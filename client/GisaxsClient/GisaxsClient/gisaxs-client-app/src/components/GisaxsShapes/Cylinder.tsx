          ...
          <Grid item xs={12}>
            <Box display="flex" sx={{ justifyContent: "space-between" }}>
              ...
              <Typography sx={{ fontSize: 14 }} color="text.secondary" gutterBottom>
                Cylinder {collapsed ? `[${jsonData.radius.mean}, ${jsonData.radius.stddev}]` : ""}
              </Typography>
            ...
            <Grid container direction={"row"} rowSpacing={1}>
              <Grid item xs={12}>
                <Box display="flex" sx={{ flexDirection: "column" }}>
                  <ShapeParameterWrapper initialParameterConfig={props.initialConfig.radius} jsonCallback={jsonCallback} parameterName="radius" />
                  <ShapeParameterWrapper initialParameterConfig={props.initialConfig.radius} jsonCallback={jsonCallback} parameterName="height" />
