...
function Content() {
    ...
    const [sampleFormDataValue, setSampleFormDataValue] = useState({});
    ...
    const sampleChangeHandler = (value: any) => {
        setSampleFormDataValue(value);
    };
    ...
    const debouncedSampleChangeHandler = useMemo(
        () => debounce(sampleChangeHandler, 50, { trailing: true }),
        []
    );
    ...
    useEffect(() => {
        ...
        const getJobRequest = () => {
            console.log({ ...sampleFormDataValue, ...instrumentationFormDataValue, ...unitcellFormDataValue, ...formDataValue, ...colormapFormDataValue });
              ...
              {(x: number, y : number, scale : number) => (
                ...
                <Grid item xs={6}>
                    ...
                    >
                        ...
                        <Grid item xs={6}>
                            <SampleForm
                                callback={debouncedSampleChangeHandler}
                                formData={sampleFormDataValue}
                            />
                        </Grid>
                        <Grid item xs={6}>
                            <UnitcellForm
