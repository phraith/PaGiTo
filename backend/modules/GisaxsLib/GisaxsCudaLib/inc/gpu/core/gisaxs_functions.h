...
{
public:
	__device__ DevUnitcell(ShapeType* shape_types, int shape_count, int rand_count, MyType3* shape_locations, int *locations_counts, MyType3I repetitions, MyType3 distances);
