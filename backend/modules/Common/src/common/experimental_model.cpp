...
ExperimentalModel::ExperimentalModel(Detector detector, const std::vector<int> position_offsets, BeamConfiguration beam_config, Sample sample, double sample_detector_dist, int level)
	:
    detector_(detector),
